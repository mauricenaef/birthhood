...
export class FormDataService {
  ...
  getBio(): Bio {
    var bio: Bio = {
      ...
      birthplace: {name: this.formData.birthplace,
      id: this.formData.birthplace_id},
    }
    return bio;
  }
  ...
  setBio(data: Bio) {
    ...
    this.formData.birthplace_id = data.birthplace.id;
    this.formData.birthplace = data.birthplace.name;
